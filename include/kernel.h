 ...
 * k_mem_pool API is implemented on top of a k_heap, which is a more
 * general purpose allocator which does not make the same promises
 * about splitting or alignment detailed above.
 *
