 ...
 * running, it returns the current time.
 *
 * @param timer     Address of timer.
 *
 ...
 * is not running, it returns zero.
 *
 * @param timer     Address of timer.
 *
...
{
	return (u32_t)k_ticks_to_ms_floor32(k_timer_remaining_ticks(timer));
}
 ...
 * delayed_work is not running, it returns zero.
 *
 * @param delayed_work     Address of delayed work item.
 *
 * @return Remaining time (in ticks).
 */
__syscall u32_t k_delayed_work_remaining_ticks(struct k_delayed_work *dw);
