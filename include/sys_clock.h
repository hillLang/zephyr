...
#define __ticks_to_ms(t) DEPRECATED_MACRO \
	k_ticks_to_ms_floor64(t)
#define z_ms_to_ticks(t) DEPRECATED_MACRO \
	k_ms_to_ticks_ceil32(t)
#define __ticks_to_us(t) DEPRECATED_MACRO \
	k_ticks_to_us_floor64(t)
#define z_us_to_ticks(t) DEPRECATED_MACRO \
	k_us_to_ticks_ceil64(t)
#define sys_clock_hw_cycles_per_tick() DEPRECATED_MACRO \
	k_ticks_to_cyc_floor32(1)
#define SYS_CLOCK_HW_CYCLES_TO_NS64(t) DEPRECATED_MACRO \
	k_cyc_to_ns_floor64(t)
#define SYS_CLOCK_HW_CYCLES_TO_NS(t) DEPRECATED_MACRO \
