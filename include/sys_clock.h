...
/** \def K_FOREVER
 * @brief Initializes a k_timeout_t object with XXX
 *
 * Evaluates to a k_timeout_t object representing an API timeout that
...
#define K_TIMEOUT_UPTIME_TICKS(t) K_TIMEOUT_TICKS((k_ticks_t)(-1LL - t))
#define K_TIMEOUT_UPTIME_MS(t) K_TIMEOUT_UPTIME_TICKS(k_ms_to_ticks_ceil64(t))
#define K_TIMEOUT_UPTIME_US(t) K_TIMEOUT_UPTIME_TICKS(k_us_to_ticks_ceil64(t))
#define K_TIMEOUT_UPTIME_CYC(t) K_TIMEOUT_UPTIME_TICKS(k_cyc_to_ticks_ceil64(t))
#endif
